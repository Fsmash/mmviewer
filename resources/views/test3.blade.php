...
<script type="module">
    ...
    function createCatapult() {
        ...
        gltfPromise.then(function(gltf) {
            ...
            // rotateAboutPoint(projectile, catapultArm.position, new THREE.Vector3(1, 0, 0), angle2);
    ...
    function updatePhysics(deltaTime) {
        ...
        // Step world
        // physicsWorld.stepSimulation(deltaTime, 2, 1 / 30);
        physicsWorld.stepSimulation(0.01, 5, 1/60);
        physicsWorld.stepSimulation(deltaTime, 600, 1 / 60000);
